...
#devtypel "_boot=" BOOTENV_SHARED_BLKDEV_BODY(devtypel)
...
#define BOOTENV_SHARED_UBIFS                           \
	...
	"ubifsumount; "                                \
	"fi\0"
#define BOOTENV_DEV_UBIFS_BOOTUBIOFF(off) \
#off /* type check, throw error when called with more args */
#define BOOTENV_DEV_UBIFS(devtypeu, devtypel, instance, bootubipart, \
	...
	"bootubioff=" BOOTENV_DEV_UBIFS_BOOTUBIOFF(                  \
		__VA_ARGS__) "; "                                    \
			     "run ubifs_boot\0"
...
#define BOOTENV_SHARED_EFI                                                 \
	...
	"run load_efi_dtb; " BOOTENV_RUN_EXTENSION_APPLY "fi;"             \
	"done;"                                                            \
...
#else
#define BOOTENV_SHARED_SATA
#define BOOTENV_DEV_SATA BOOT_TARGET_DEVICES_references_SATA_without_CONFIG_SATA
...
#define BOOTENV_SHARED_NVME                                     \
	...
	"fi\0"                                                  \
                                                                \
	"nvme_boot=" BOOTENV_RUN_PCI_ENUM BOOTENV_RUN_NVME_INIT \
...
#define BOOTENV_SHARED_NVME
#define BOOTENV_DEV_NVME BOOT_TARGET_DEVICES_references_NVME_without_CONFIG_NVME
...
#define BOOTENV_SHARED_SCSI                                     \
	...
	"fi\0"                                                  \
                                                                \
	"scsi_boot=" BOOTENV_RUN_PCI_ENUM BOOTENV_RUN_SCSI_INIT \
...
#define BOOTENV_SHARED_SCSI
#define BOOTENV_DEV_SCSI BOOT_TARGET_DEVICES_references_SCSI_without_CONFIG_SCSI
...
#define BOOTENV_SHARED_IDE
#define BOOTENV_DEV_IDE BOOT_TARGET_DEVICES_references_IDE_without_CONFIG_IDE
...
#define BOOTENV_SHARED_PCI "boot_pci_enum=pci enum\0"
#else
...
#define BOOTENV_SHARED_USB               \
	...
	"usb_boot="                      \
	"usb start; " BOOTENV_SHARED_BLKDEV_BODY(usb)
...
#define BOOTENV_SHARED_VIRTIO                                       \
	...
	"fi\0"                                                      \
                                                                    \
	"virtio_boot=" BOOTENV_RUN_PCI_ENUM BOOTENV_RUN_VIRTIO_INIT \
...
#define BOOTENV_DEV_DHCP(devtypeu, devtypel, instance)      \
	"bootcmd_dhcp="                                     \
	"devtype=" #devtypel                                \
	"; " BOOTENV_RUN_NET_USB_START BOOTENV_RUN_PCI_ENUM \
...
#define BOOTENV_DEV_PXE(devtypeu, devtypel, instance)                          \
	"bootcmd_pxe=" BOOTENV_RUN_NET_USB_START BOOTENV_RUN_PCI_ENUM "dhcp; " \
	"if pxe get; then "                                                    \
	"pxe boot; "                                                           \
	"fi\0"
...
#define BOOTENV                                                                  \
	...
	"boot_script_dhcp=boot.scr.uimg\0" BOOTENV_BOOT_TARGETS                  \
                                                                                 \
